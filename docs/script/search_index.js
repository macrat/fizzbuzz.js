window.esdocSearchIndex = [
  [
    "fizzbuzz~modrule",
    "function/index.html#static-function-modRule",
    "<span>modRule</span> <span class=\"search-result-import-path\">fizzbuzz</span>",
    "function"
  ],
  [
    "fizzbuzz~range",
    "function/index.html#static-function-range",
    "<span>range</span> <span class=\"search-result-import-path\">fizzbuzz</span>",
    "function"
  ],
  [
    "fizzbuzz~replace",
    "function/index.html#static-function-replace",
    "<span>replace</span> <span class=\"search-result-import-path\">fizzbuzz</span>",
    "function"
  ],
  [
    "modrule src/fizzbuzz.mjs~modrule,modrule",
    "test-file/test/fizzbuzz.mjs.html#lineNumber57",
    "modRule",
    "test"
  ],
  [
    "",
    "test-file/test/fizzbuzz.mjs.html#lineNumber58",
    "modRule simple",
    "test"
  ],
  [
    "range src/fizzbuzz.mjs~range,range",
    "test-file/test/fizzbuzz.mjs.html#lineNumber7",
    "range",
    "test"
  ],
  [
    "",
    "test-file/test/fizzbuzz.mjs.html#lineNumber8",
    "range ascending list",
    "test"
  ],
  [
    "",
    "test-file/test/fizzbuzz.mjs.html#lineNumber14",
    "range descending list",
    "test"
  ],
  [
    "",
    "test-file/test/fizzbuzz.mjs.html#lineNumber26",
    "range invalid step",
    "test"
  ],
  [
    "",
    "test-file/test/fizzbuzz.mjs.html#lineNumber20",
    "range negative value",
    "test"
  ],
  [
    "replace src/fizzbuzz.mjs~replace,replace",
    "test-file/test/fizzbuzz.mjs.html#lineNumber34",
    "replace",
    "test"
  ],
  [
    "",
    "test-file/test/fizzbuzz.mjs.html#lineNumber44",
    "replace default value",
    "test"
  ],
  [
    "",
    "test-file/test/fizzbuzz.mjs.html#lineNumber35",
  ...
  [
    "src/console.mjs",
    "file/src/console.mjs.html",
    "src/console.mjs",
    "file"
  ],
  [
    "src/fizzbuzz.mjs",
    "file/src/fizzbuzz.mjs.html",
    "src/fizzbuzz.mjs",
    "file"
  ],
  [
    "src/fizzbuzz.mjs~replacerule",
    "typedef/index.html#static-typedef-ReplaceRule",
    "src/fizzbuzz.mjs~ReplaceRule",
    "typedef"
  ],
  [
    "test/fizzbuzz.mjs",
    "test-file/test/fizzbuzz.mjs.html",
    "test/fizzbuzz.mjs",
    "testFile"
  ]
]